...
class _EditPerbaikanState extends State<EditPerbaikan> {
  ...
  void save(id_penangan_perbaikan) {
    ...
    BlocProvider.of<SaveEditPerbaikanCubit>(context).postEditPerbaikan(
        ...
        tabels
            .map(
              (e) => MyTable(e.id_struktur_mesin, e.nama, e.id_material,
                  e.jumlah, e.catatan),
            )
            .toList());
  }
              ...
              if (state is SaveEditPerbaikanLoaded) {
                ...
                if (statusCode == 200) {
                  final materialBanner =
                      MyBanner.bannerSuccess(json['message']);
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child:
                            Text("Pilih : ", style: TextStyle(fontSize: 15.0)),
                      ),
