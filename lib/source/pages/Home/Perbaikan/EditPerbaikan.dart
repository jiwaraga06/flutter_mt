...
class _EditPerbaikanState extends State<EditPerbaikan> {
  ...
  String? keys, kode_penugasan, _valDropdown, id_penanganan_perbaikan;
  ...
  add() {
    MyTable table = MyTable(
        _treeViewController!.getNode(_selectedNode!)!.key, '', 0, '', '');
  ...
  void save() {
    // print(tabels);
    BlocProvider.of<SaveEditPerbaikanCubit>(context).postEditPerbaikan(id_penanganan_perbaikan, tabels.toList());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocListener<EditPerbaikanCubit, EditPerbaikanState>(
        listener: (context, state) {
          if (state is EditPerbaikanLoaded) {
            var detail = state.json;
            id_penanganan_perbaikan = detail['id_penanganan_perbaikan'].toString();
            detail['detail_perbaikan'].forEach((e) {
              MyTable table = MyTable(
                  e['id_struktur_mesin'],
                  e['nama_komponen'],
                  e['id_material'],
        ...
        child: BlocListener<SaveEditPerbaikanCubit, SaveEditPerbaikanState>(
                  ...
                  children: [
                    ...
                    BlocBuilder<TreeViewCubit, TreeViewState>(
                      builder: (context, state) {
                        ...
                        _treeViewController =
                            _treeViewController!.loadJSON(json: json);
                        // return Container(
                        //   child: Text(json),
                        // );
                        return Container(
                          ...
                          child: TreeView(
                            ...
                            onNodeTap: (key) {
                              ...
                              setState(() {
                                ...
                                isiTreeView = _treeViewController!
                                  ...
                                  builder: (BuildContext) {
                                    return AlertDialog(
                                      content: Column(
                                        ...
                                        children: [
                                          Text("Anda ingin hapus kolom ini ?")
                                        ],
                                      ),
                                      actions: [
                                        TextButton(
                                  ...
                                  TableRow(children: [
                                    ...
                                    Text(":",
                                        style: TextStyle(
                                            fontSize: 16,
                                            fontWeight: FontWeight.w600)),
                                    Text(data.id_struktur_mesin.toString(),
                                    ...
                                    BlocBuilder<MaterialCubit, MaterialStates>(
                                      builder: (context, state) {
                                        ...
                                        return DropdownButtonFormField<dynamic>(
                                          isExpanded: true,
                                          value: data.id_material == 0?null:data.id_material,
