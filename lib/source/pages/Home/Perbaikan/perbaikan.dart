...
class _PerbaikanState extends State<Perbaikan>
  ...
  Future<void> scanQR(id_mesin, kode_penugasan, tgl_penugasan, nama_lokasi,
      nama_mesin, status_delegasi) async {
    ...
    if (barcodeScanRes != '-1') {
      if (id_mesin.toString() == barcodeScanRes) {
        ...
        if (status_delegasi == 0) {
          ...
          Navigator.pushNamed(context, EDIT_PERBAIKAN,
              arguments: {'id_perbaikan': id_mesin, 'id_delegasi': kode_penugasan});
        }
      } else {
                  ...
                  return Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        perbaikan['status_delegasi'] == 3?CustomButton4(
                                text: "Sudah di Close",
                          ...
                          onPressed: perbaikan['status_delegasi'] == 1
                              ...
                              : () {
                                  scanQR(
                                      ...
                                      perbaikan['status_delegasi']);
                                },
                          text: perbaikan['status_delegasi'] == 1
                              ? "Dalam Review"
                              : "Quick Scan",
